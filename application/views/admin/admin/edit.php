...
<div class="wrapper">
  <div class="widget">
   ...
   <form id="form" class="form" enctype="multipart/form-data" method="post" action="">
    ...
    <div class="formRow">
     <label for="param_username" class="formLeft">Username:</label>
     <div class="formRight">
      <span class="oneTwo"><input type="text" _autocheck="true" value="<?php echo $info->username?>" id="param_username" name="username" readonly="true" ></span>
      <span class="autocheck" name="name_autocheck"></span>
