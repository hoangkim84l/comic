   ...
   <div class="widget">
      ...
      <form id="form" class="form" enctype="multipart/form-data" method="post" action="">
         <fieldset>
            ...
            <div class="formRow">
               <label for="param_description" class="formLeft">Mô tả:</label>
               <div class="formRight">
                  <span class="oneTwo"><input type="text" _autocheck="true" id="param_description" value="<?php echo $info->description?>" name="description"></span>
                  <span class="autocheck" name="name_autocheck"></span>
