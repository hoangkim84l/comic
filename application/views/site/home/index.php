  ...
  <div class="flex flex-row items-center md:pr-6">
    <div class="mr-6 self-center text-left">
      <div class="relative inline-block text-left">
        <div><button class="inline-flex justify-center rounded-full bg-indigo-500 px-4 py-2 shadow-xl shadow-indigo-100 transition hover:scale-105 hover:bg-indigo-600 hover:shadow-indigo-200 focus:outline-none md:hidden" id="headlessui-menu-button-undefined" type="button" aria-haspopup="true" aria-expanded="false"><svg stroke="currentColor" fill="none" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" class="text-white" aria-hidden="true" height="25" width="25" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="relative z-50 mt-1 w-full md:w-2/5">
      <div class="relative w-full cursor-default overflow-hidden rounded-full bg-white text-left focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75 focus-visible:ring-offset-2 focus-visible:ring-offset-teal-300 sm:text-sm">
        <input type="text" autoComplete="off" class="w-full border-none bg-gray-300 py-3 pl-3 pr-10 text-sm leading-5 text-gray-800 outline-none focus:ring-0" placeholder="Search..." id="headlessui-combobox-input-undefined" role="combobox" aria-expanded="false" /><button class="absolute inset-y-0 right-0 flex items-center pr-3" id="headlessui-combobox-button-undefined" type="button" tabindex="-1" aria-haspopup="true" aria-expanded="false"><svg stroke="currentColor" fill="none" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" class="h-5 w-5 text-gray-400" aria-hidden="true" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="flex-row space-x-4 2xl:flex">
      <div class="2xl:basis-9/12">
        <div class="z-50 space-y-8 rounded-3xl bg-white p-8">
          ...
          <div class="flex space-x-2"><button class="rounded-full bg-indigo-500 p-2 text-xl text-white shadow-lg shadow-indigo-200 transition duration-200 hover:scale-105"><svg stroke="currentColor" fill="none" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                <line x1="19" y1="12" x2="5" y2="12"></line>
                <polyline points="12 19 5 12 12 5"></polyline>
              </svg></button><button class="rounded-full bg-indigo-500 p-2 text-xl text-white shadow-lg shadow-indigo-200 transition duration-200 hover:scale-105"><svg stroke="currentColor" fill="none" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
...
$(document).ready(function(){
  var found = {};
  console.log('oaosoaos');
  jQuery('[data-id]').each(function(){
    console.log('oaosoaos12121');
      var $this = $(this);
