<nav class="sidebar sidebar-active"><button class="btn btn-close"><img src="<?php echo public_url() ?>site/assets/x.svg" alt="close"></button>
    <div class="sidebar-content">
        ...
        <ul class="list-unstyled components avatar-section">
            ...
            <?php else : ?>
                ...
                <li class="nav-item">
                    <a class="nav-link text-dark" href="javascript:void(0)"><img class="img-icon" src="<?php echo base_url('upload/banner/icon/icon_01.png'); ?>" alt="cafe sữa novel, Web comic truyện tranh, truyện nhân gian"> Người lạ nơi cuối con đường</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-dark" href="<?php echo site_url('user/register') ?>"><img class="img-icon" src="<?php echo base_url('upload/banner/icon/icon_10.png'); ?>" alt="cafe sữa novel"> Đăng ký</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-dark" href="<?php echo site_url('user/login') ?>"><img class="img-icon" src="<?php echo base_url('upload/banner/icon/icon_08.png'); ?>" alt="cafe sữa novel"> Đăng nhập</a>
                </li>
        ...
        <ul class="list-unstyled CTAs">
            <li>
                <p class=" text-dark">Copyright ©<script>
                        var CurrentYear = new Date().getFullYear()
                        document.write(CurrentYear)
                    </script> <?php echo $support->copyright ?></p>
            </li>
            <li>
