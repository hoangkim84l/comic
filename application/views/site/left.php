<nav class="sidebar sidebar-active"><button class="btn btn-close"><img src="assets/x.svg" alt="close"></button>
    <div class="sidebar-content">
        <h2>MOTION STATION</h2><select class="form-control">
            <option value="0" disabled="disabled">Choose Language</option>
        ...
        <ul class="list-group">
            <li class="list-group-item"><a href="index-2.html"><img src="assets/Group%20398.svg" alt="Dashboard">
                    <span>Dashboard</span></a></li>
            <li class="list-group-item"><a href="pages/supscriptions.html"><img src="assets/Group%20399.svg" alt="Supscriptions"> <span>Supscriptions</span></a></li>
            <li class="list-group-item"><a href="pages/premium.html"><img src="assets/Path%20242.svg" alt="Premium">
                    <span class="text-premium">Premium</span></a></li>
            <li class="list-group-item line-bottom"></li>
            <li class="list-group-item"><a href="pages/uploadvideo.html"><img src="assets/Group%20400.svg" alt="Upload"> <span>Upload</span></a></li>
            <li class="list-group-item login"><a href="pages/createaccount.html"><img src="assets/Avatar.svg" alt="avatar"> <span>Name Surname/Log in</span></a></li>
            <li class="list-group-item line-top"></li>
            <li class="list-group-item">
                <h6>IMAGES THAT COMES TO LIFE</h6>
            </li>
            <li class="list-group-item social-network"><a href="#" class="icon"><img class="facebook" src="assets/facebook.svg" alt="Facebook"> </a><a href="#" class="icon"><img class="instagram" src="assets/instagram.svg" alt="Instagram"></a></li>
        </ul>
    </div>
</nav>
