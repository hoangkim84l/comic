          ...
          <div class="col-lg-5 col-sm-12">
            ...
            <span class="info-book" title="Submit Yêu Thích để nhận mail khi có chap mới nha.">
              <form action="<?php echo site_url('stories/love_lists')?>" method="post">
                ...
                <?php endif;?>
                <div class="fb-like" data-href="<?php echo site_url('xem-truyen/'.$stories->slug.'/'.$stories->id)?>" data-width="" data-layout="button_count" data-action="like" data-size="large" data-share="true"></div>
              </form>
            </span>
          </div>
        </div>
  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-lg-12">
        ...
        <div class="tab-content" id="myTabContent">
          <div class="tab-pane fade show" id="home-cafesua" role="tabpanel" aria-labelledby="home-tab-cafesua">
            <br/>
            <?php if(isset($user_info)):?>
