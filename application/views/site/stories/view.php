      ...
      <section>
        <div class="container-fluid">
          <div class="row">
                          ...
                          <div class="container-fluid">
                            <div class="scrollbar scrollbar-type-3" id="style-1">
                              <div class="force-overflow">
                                <div class="row">
                                  <?php foreach ($list_chapters as $row) : if ($row->status == 0) {
                                    } else { ?>
                          ...
                          <div class="col-lg-6 media mb-4 ">
                            ...
                            <div class="media-body">
                              <ul class="list-inline d-flex justify-content-between mb-2">
                                <li class="list-inline-item"><i class="ti-user mr-2"></i> <?php echo $row_stories->author ?> <br /> <?php $date = date_create($row_stories->created);
            ...
            <div class="col-lg-4">
              <div class="widget"><br />
                <a href="<?php echo site_url('danh-sach-chuong/' . $stories->slug . '/' . $stories->id) ?>">
              ...
              <div class="widget">
                ...
                <?php foreach ($view_stories as $row_stories) : if ($row_stories->status == 0) {
                  } else { ?>
                    <div class="media mb-4">
